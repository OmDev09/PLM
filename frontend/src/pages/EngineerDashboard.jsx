...
import { Menu, Search, UserCircle, FileText, Database, ChevronDown, ChevronRight, Activity } from 'lucide-react';
                        ...
                        <div className="relative cursor-pointer" onMouseEnter={() => setProfileOpen(true)} onMouseLeave={() => setProfileOpen(false)}>
                            <div className="flex items-center gap-3">
                                <div className="hidden sm:flex flex-col items-end">
                                    <span className="text-sm font-bold text-slate-800 dark:text-white leading-tight">{user?.email || 'engineer@plm.com'}</span>
                                    <span className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest leading-tight">Engineer Dashboard</span>
                                </div>
