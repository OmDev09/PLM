...
import { Menu, Search, UserCircle, FileText, Activity } from 'lucide-react';
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto py-4 w-[260px] custom-scrollbar">
                    <nav className="space-y-1">
                        ...
                        {renderNavLink('ecos', <FileText />, 'Actionable ECOs')}
                        ...
                        <div className="relative cursor-pointer" onMouseEnter={() => setProfileOpen(true)} onMouseLeave={() => setProfileOpen(false)}>
                            <div className="flex items-center gap-3">
                                <div className="hidden sm:flex flex-col items-end">
                                    <span className="text-sm font-bold text-slate-800 dark:text-white leading-tight">{user?.email || 'approver@plm.com'}</span>
                                    <span className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest leading-tight">Approver Dashboard</span>
                                </div>
